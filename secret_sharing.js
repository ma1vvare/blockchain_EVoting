...
function join(shares) {
  console.log(shares[0],typeof(shares[0]),shares[1],typeof(shares[1]),shares[2],typeof(shares[2]));
    ...
    for(formula = accum = 0; formula < shares.length; formula++) {
        ...
        console.log("prime : ",prime,typeof(prime));
        console.log("numerator : ",numerator,typeof(numerator));
        console.log("denominator : ",denominator,typeof(denominator));
        accum = (prime + accum + (value * numerator * modInverse(denominator))) % prime;
        console.log("accum : ",accum,typeof(accum));
    }
    console.log("return accum : ",accum,typeof(accum));
    return accum;
}
var sh = split(10, 5, 3) /* split the secret value 129 into 6 components - at least 3 of which will be needed to figure out the secret value */
